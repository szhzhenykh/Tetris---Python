...
class Start_screen:
    def __init__(self, w, h, s):
        ...
        self.monoimage = pygame.transform.scale(pygame.image.load(self.monoimage), (self.blocks.width,
                                                                                    self.blocks.width))
        self.doimage = pygame.transform.scale(pygame.image.load(self.doimage), (self.blocks.width,
                                                                                self.blocks.width))
        self.triimage = pygame.transform.scale(pygame.image.load(self.triimage), (self.blocks.width,
                                                                                  self.blocks.width))
        self.pentaimage = pygame.transform.scale(pygame.image.load(self.pentaimage), (self.blocks.width,
                                                                                      self.blocks.width))
...
class Game:
    def __init__(self, shapes, width, height):
        ...
        self.shadowimage = pygame.transform.scale((pygame.image.load('shadow.png')),
                                                  (self.block.width, self.block.width))  # Ghost shape block image
    ...
    def choosing(self):
        ...
        if self.choose:
            ...
            self.next_image = pygame.transform.scale(pygame.image.load(nextImage), (self.block.width, self.block.width))
            self.tetr, block, self.rotationBool, self.off = self.shape.tetromino(chosen, True)
            self.block_image = pygame.transform.scale(pygame.image.load(block),
                                                      (self.block.width, self.block.width))
...
# Images
backMain = pygame.transform.scale(pygame.image.load('july.jpg'), (width, height))
# Background for Start, Game and Game over screens
backSet = pygame.transform.scale(pygame.image.load('june.jpg'), (width, height))  # Background for Setting Screen
french = pygame.transform.scale(pygame.image.load('french.png'), (50, 40))  # Icon for French button
english = pygame.transform.scale(pygame.image.load('english.png'), (50, 40))  # Icon for English
russian = pygame.transform.scale(pygame.image.load('russian.png'), (50, 40))  # Icon for Russian
pauseImage = pygame.transform.scale(pygame.image.load('pause.png'), (width, height))
# Screen darkener in main game pause
selectimage = pygame.transform.scale(pygame.image.load('Seleceted.png'), (30, 30))  # Check mark for shape options
unselectimage = pygame.transform.scale(pygame.image.load('Unselected.png'), (30, 30))  # Empty check mark
